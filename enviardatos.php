...
<body>
    ...
    // Enviar la info por email
            ...
            $cuerpoMensaje = "Nombre: ".$nombre."<br> Apellido: ".$apellido."<br> Ocupacion: ".$ocupacion."<br> Edad: ".$edad."<br> Email: ".$email;
            ...
            // 4) Evaluacion del envio
             ...
             $consulta_alta = "INSERT INTO usuarios VALUES(0,'$nombre','$apellido','$ocupacion','$edad','$email','$fechaEnvio')";
